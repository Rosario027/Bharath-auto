...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="login2">
      ...
      <div className="login2-inner">
        {/* Left — form */}
        <form className="login2-form" onSubmit={submit}>
          <h1>Welcome back!</h1>
          <p className="l2-sub">Simplify your invoicing and boost your productivity with <b>Bharath Automation</b>. Sign in to continue.</p>
          ...
          <label className="l2-field l2-pass">
            ...
            <button type="button" className="l2-eye" onClick={() => setShow((s) => !s)} aria-label="Toggle password">
              {show ? '🙈' : '👁'}
            </button>
          </label>
          ...
          <button className="l2-btn" type="submit" disabled={busy || !username || !password}>
            {busy ? 'Signing in…' : 'Login'}
          </button>

          <p className="l2-foot">Bharath Automation · Invoicing Portal</p>
        </form>

        {/* Right — calm illustration panel */}
        <div className="login2-art">
          <div className="l2-card">
            <div className="l2-card-title">Invoice Ready</div>
            <div className="l2-card-sub">GST · CGST + SGST</div>
            <div className="l2-card-row">
              <span className="l2-chip">Paid</span>
              <span className="l2-ring">100%</span>
            </div>
          </div>
          <MeditationArt />
          <div className="l2-tag">Make your work easier and organized<br />with <b>Bharath Automation</b></div>
        </div>
      </div>
    </div>
  );
